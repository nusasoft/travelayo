...
<div id="cover">
    <div id="header-wrapper">
        <header id="header" class="responsive">
            <div id="branding">
                <h1>
                    <?php if($version !== null):?><a href="<?php echo $version['html_url']; ?>" target="_blank"> HTMLy <small>/<?php echo $version['tag_name']; ?>/</small></a><?php else: ?>HTMLy<?php endif;?>
                </h1>
                <div id="blog-tagline">
...
ErrorDocument 404 /online-installer.php

# Set the default handler.
DirectoryIndex online-installer.php
...
# Pass all requests not referring directly to files in the filesystem to index.php.
  ...
  RewriteRule ^ online-installer.php [L]
